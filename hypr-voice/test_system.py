...
async def main():
    ...
    config_files = {
        os.path.join(script_dir, "config/app_profiles.yaml"): "Application profiles",
        os.path.join(script_dir, "config/llm_providers.yaml"): "LLM provider settings",
        os.path.join(script_dir, ".env"): "Environment configuration"
    }
    ...
    print("   - Whisper: python3 whisper/server.py")
    print("3. Run the client: python3 hypr_voice.py --realtime")
    print()
