...
try:
    from ..core.enhanced_context_manager import EnhancedContextManager, get_enhanced_context_manager
...
class VocabularyManager:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        """
        self.config_dir = Path(config_path) if config_path else get_whisper_config_dir()
    ...
    def update_vocabulary(self, app_name: Optional[str] = None, app_title: Optional[str] = None, backend: Optional[str] = None):
        ...
        if backend:
            if backend != self.current_backend:
                ...
                emit('backend_change', backend_name=backend)
