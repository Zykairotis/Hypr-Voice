...
**Location:** `/home/mewtwo/Zykairotis/Hypr-Voice/src/Hypr-Whisper/config/notifications.yaml`
...
**Location:** `/home/mewtwo/Zykairotis/Hypr-Voice/src/Hypr-Whisper/config/audio-profile.yaml`
...
**When enabled:**
- Recordings saved to: `src/Hypr-Whisper/recordings/`
...
```bash
ls -ld src/Hypr-Whisper/recordings/
# Should show: drwxr-xr-x

# If missing:
mkdir -p src/Hypr-Whisper/recordings/
chmod 755 src/Hypr-Whisper/recordings/
```
